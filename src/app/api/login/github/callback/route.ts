...
import {
  createWorkspace,
} from "@/actions/workspace/workspace-action";
...
export async function GET(request: Request): Promise<Response> {
  ...
  try {
    ...
    if(existingUser && existingUser.workspaceId === null) {
      console.log("existing user without workspaceId");
    await createWorkspace({ name: githubUser.name, userId: existingUser.id });
    ...
    await createWorkspace({ name: githubUser.name, userId: userId });
