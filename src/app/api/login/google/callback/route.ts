import { createWorkspace, updateUserWorkspaceInUserTable } from "@/actions/workspace/workspace-action";
...
export async function GET(request: Request): Promise<Response> {
  ...
  try {
    ...
    const existingAccount = await db.query.oauthAccountTable.findFirst({
      ...
      await createWorkspace({ name: googleUser.name, userId: existingUser.id });
