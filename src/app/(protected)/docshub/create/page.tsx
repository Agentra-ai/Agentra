...
const CreateAppDocument = (props: Props) => {
  ...
  const handleNextStep = async () => {
    if (currentStep === 2) {
      ...
      try {
        console.log("3RD STEP --- Uploading and embedding file...");
  ...
  const uploadAndEmbedFile = async () => {
    ...
    try {
      ...
      const AWSS3data = await res.json();
          ...
          <div>
            ...
            <div className="mt-4 w-[500px]">
              <input
                ...
                className="mb-4 block w-full text-sm text-gray-500 file:mr-4 file:rounded-md file:border-0 file:bg-blue-50 file:px-4 file:py-2 file:text-sm file:font-semibold file:text-blue-600 hover:file:bg-blue-100"
              />
              {fileName && (
