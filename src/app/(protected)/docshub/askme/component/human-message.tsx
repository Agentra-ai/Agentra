...
//   isLast: boolean;
// };
// export const HumanMessage = ({ chatMessage }: any) => {
//   const { rawHuman, inputProps } = chatMessage;
//   return (
//     <>
//       {inputProps?.context && (
//         <div className="bg-zinc-50 text-zinc-600 dark:text-zinc-100 dark:bg-black/30 rounded-2xl p-2 text-sm md:text-base flex flex-row gap-2 pr-4 border hover:border-white/5 border-transparent">
