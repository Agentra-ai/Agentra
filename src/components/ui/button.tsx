...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "rounded-[6px] bg-[#1155ff] text-primary-foreground shadow hover:bg-blue-800",
        blue: "rounded-[6px] bg-[#1155ff] text-primary-foreground shadow hover:bg-blue-800",
        gray: "bg-gray-200 text-black hover:bg-gray-300",
        whiteblue: "hover:bg-gray-100 bg-white text-[#1155ff] rounded-lg shadow-md",
        destructive:
