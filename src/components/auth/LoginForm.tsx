...
export default function LoginForm() {
  ...
  return (
    <div className="flex h-full w-full items-center justify-center">
      <div className="flex shadow bg-gradient-to-t from-purple-50 to-blue-50 p-3 rounded-lg h-full w-full justify-center items-center">
      <div className="flex w-full max-w-sm flex-col gap-4 rounded-large bg-content1 px-8 pb-10 pt-6 shadow-small">
        <h1 className="text-3xl font-bold">Welcome to floxify</h1>
        <p className="text-center text-small">
          Log in with your email or a provider to continue
        </p>
        <ProviderForm />
        <p className="text-center text-small">
